...
export function AiOptimizationPanel({ articleId, updatedAt, configured, hasUnsavedChanges, prepareArticle, accessToken, onApplied }: {
  ...
  return <section className="rounded-2xl border border-amber-300 bg-amber-50/50 p-5">
    ...
    {result && <div className="mt-5 space-y-5">
      ...
      <div className="rounded-xl bg-white p-4"><h3 className="font-semibold">文章預覽</h3><h4 className="mt-3 text-lg font-semibold">{result.article.title}</h4><p className="mt-2 text-sm text-neutral-600">{result.article.excerpt}</p><div className="mt-3 max-h-72 overflow-auto border-t pt-3 text-sm leading-7 [&_h2]:mb-2 [&_h2]:mt-5 [&_h2]:text-xl [&_h2]:font-semibold [&_h3]:mb-2 [&_h3]:mt-4 [&_h3]:text-lg [&_h3]:font-semibold [&_h4]:mb-1 [&_h4]:mt-3 [&_h4]:font-semibold [&_ol]:my-3 [&_ol]:list-decimal [&_ol]:pl-6 [&_p]:mb-3 [&_ul]:my-3 [&_ul]:list-disc [&_ul]:pl-6" dangerouslySetInnerHTML={{ __html: result.article.content_html }} /></div>
