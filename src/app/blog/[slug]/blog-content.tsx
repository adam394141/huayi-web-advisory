  ...
  return (
    <article className="px-[var(--space-page-x)] pb-20 pt-16 md:pt-24">
      <div className="mx-auto max-w-[800px]">
        ...
        {post.content && (
          <div
            className="mt-10 text-[15px] leading-[1.9] text-[var(--color-body)] [&_a]:text-[var(--color-gold-dark)] [&_a]:underline [&_blockquote]:my-6 [&_blockquote]:border-l-2 [&_blockquote]:border-[var(--color-gold)] [&_blockquote]:pl-5 [&_blockquote]:italic [&_blockquote]:text-[var(--color-subtle)] [&_figcaption]:mt-3 [&_figcaption]:text-center [&_figcaption]:text-sm [&_figcaption]:text-[var(--color-subtle)] [&_figure]:my-8 [&_figure]:overflow-hidden [&_figure]:rounded-[var(--radius-image)] [&_figure_img]:h-auto [&_figure_img]:w-full [&_figure_img]:object-contain [&_h2]:mb-4 [&_h2]:mt-12 [&_h2]:font-serif [&_h2]:text-2xl [&_h2]:font-semibold [&_h2]:text-[var(--color-fg)] [&_h3]:mb-3 [&_h3]:mt-9 [&_h3]:font-serif [&_h3]:text-xl [&_h3]:font-semibold [&_h3]:text-[var(--color-fg)] [&_h4]:mb-2 [&_h4]:mt-7 [&_h4]:font-semibold [&_h4]:text-[var(--color-fg)] [&_li]:mb-1 [&_ol]:mb-5 [&_ol]:list-decimal [&_ol]:pl-6 [&_p]:mb-4 [&_table]:my-7 [&_table]:block [&_table]:w-full [&_table]:overflow-x-auto [&_td]:border [&_td]:border-[var(--color-surface-alt)] [&_td]:p-3 [&_th]:border [&_th]:border-[var(--color-surface-alt)] [&_th]:bg-[var(--color-surface)] [&_th]:p-3 [&_th]:text-left [&_ul]:mb-5 [&_ul]:list-disc [&_ul]:pl-6"
